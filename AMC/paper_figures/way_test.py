...
plt.plot(snr_range, results1, label=f'3way', color=colors[0],
         marker=markers[0], linestyle=line_type[0], lw=lw, markersize=markersize, mew=mew)
plt.plot(snr_range, results2, label=f'5way', color=colors[1],
         marker=markers[1], linestyle=line_type[1], lw=lw, markersize=markersize, mew=mew)
plt.plot(snr_range, results3, label=f'7way', color=colors[2],
