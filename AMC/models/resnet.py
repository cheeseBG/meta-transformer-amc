...
class ResidualUnit(nn.Module):
    def __init__(self, in_channels, max_pool=False, first=False):
        ...
        self.relu = nn.ReLU()
        self.first = first
        self.max_pool_first = nn.MaxPool2d(kernel_size=(2, 2), stride=(1, 2))
...
class ResNetStack(nn.Module):
    def __init__(self):
        ...
        self.res_unit2 = ResidualUnit(32, False, True)
        self.res_units = nn.ModuleList([ResidualUnit(32, True) for _ in range(4)])
